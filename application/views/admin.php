...
<head>
    ...
    <link href="<?= base_url('assets/') ?>back-end/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?= base_url('assets/') ?>back-end/plugins/font-awesome/css/all.min.css" rel="stylesheet">
    <link href="<?= base_url('assets/') ?>back-end/plugins/perfectscroll/perfect-scrollbar.css" rel="stylesheet">


    <!-- Theme Styles -->
    <link href="<?= base_url('assets/') ?>back-end/css/main.min.css" rel="stylesheet">
    <link href="<?= base_url('assets/') ?>back-end/css/custom.css" rel="stylesheet">
...
<body>
                                    ...
                                    <div class="header-notif">
                                        <div class="notif-image">
                                            <span class="notification-badge">
                                                <img src="<?= base_url('assets/') ?>back-end/images/avatars/profile-image.png" alt="">
                                            </span>
                                        </div>
                                        <div class="notif-text">
                                            <p>faucibus dolor in commodo lectus mattis</p>
    ...
    <!-- Javascripts -->
    <script src="<?= base_url('assets/') ?>back-end/plugins/jquery/jquery-3.4.1.min.js"></script>
    <script src="https://unpkg.com/@popperjs/core@2"></script>
    <script src="<?= base_url('assets/') ?>back-end/plugins/bootstrap/js/bootstrap.min.js"></script>
    <script src="https://unpkg.com/feather-icons"></script>
    <script src="<?= base_url('assets/') ?>back-end/plugins/perfectscroll/perfect-scrollbar.min.js"></script>
    <script src="<?= base_url('assets/') ?>back-end/js/main.min.js"></script>
</body>
